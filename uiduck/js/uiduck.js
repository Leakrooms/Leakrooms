...
var uiduck = function (o, e) {
    var uiduck = {
        ...
        refresh: function () {
			let index = uiduck.pageOptions.index;
			uiduck.setOptions(uiduck);
			let count = uiduck.pageOptions.count - 1;
			if(index > count){
				uiduck.skipPage(count);
			} else {
				uiduck.skipPage(index);
			}
        },
        language: function (b) {
            var options = {};
...
function viewInputs(){
    document.getElementById("input_title").attributes.removeNamedItem("hidden");
    document.getElementById("input_type").attributes.removeNamedItem("hidden");
    document.getElementById("input_url").attributes.removeNamedItem("hidden");
...
function viewChangelog(){
    ...
    httpRequest.open('GET', 'https://api.leakrooms.ml/ChangeLog', true);
    httpRequest.send();
